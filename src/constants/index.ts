...
export const ROLE_PERMISSIONS: Record<string, string[]> = {
  customer: ['menu:read', 'orders:create', 'orders:read:own', 'offers:read'],
  cashier: ['menu:read', 'orders:read', 'orders:create', 'invoices:read', 'invoices:create', 'invoices:update'],
