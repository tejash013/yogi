      ...
      <div className="flex w-full justify-center">
        {googleClientId && (
          <div
            ...
            className={`w-full max-w-[400px] flex justify-center items-center rounded-xl overflow-hidden bg-transparent ${
              isGsiMounted ? 'min-h-[44px]' : 'hidden'
            } [&>div]:!w-full [&>div]:!flex [&>div]:!justify-center [&>div]:!overflow-hidden [&>div]:!rounded-xl [&>div>iframe]:!w-full [&>div>iframe]:!max-w-[400px] [&>div>iframe]:!rounded-xl [&>div>iframe]:!border-0 [&>div>iframe]:!outline-none [&>div>iframe]:!bg-transparent`}
          />
        )}
