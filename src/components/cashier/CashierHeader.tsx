...
export default function CashierHeader({ onLogout }: Props) {
  ...
  return (
    <header className="sticky top-0 z-40 overflow-x-hidden border-b border-neutral-200 bg-white/95 text-neutral-900 shadow-sm backdrop-blur-md dark:border-neutral-800 dark:bg-neutral-900/95 dark:text-neutral-100">
      <div className="mx-auto flex min-h-16 max-w-[1920px] items-center justify-between gap-2 px-3 py-2 sm:px-4 lg:px-6">
        {/* Left: Brand & New Bill */}
        ...
        <div className="flex min-w-0 items-center gap-1.5 shrink-0 sm:gap-2">
          ...
          <div className="flex items-center gap-1.5 border-l border-neutral-200 pl-1.5 dark:border-neutral-800 sm:gap-2 sm:pl-2">
            ...
            <button
              ...
              className="ml-0.5 rounded-lg bg-red-50 p-1.5 text-red-600 transition-colors hover:bg-red-100 dark:bg-red-950/30 dark:text-red-400 dark:hover:bg-red-900/50 sm:ml-1"
              title="Logout"
              aria-label="Logout"
            >
      ...
      {isMobileMenuOpen && (
        <div className="border-t border-neutral-200 bg-white p-3 dark:border-neutral-800 dark:bg-neutral-900 xl:hidden space-y-2">
          ...
          <div className="flex flex-wrap items-center justify-between gap-2 border-t border-neutral-200 pt-2 text-xs dark:border-neutral-800">
            <span className="text-neutral-500 dark:text-neutral-400">Shift Total: <strong className="text-neutral-800 dark:text-neutral-200">{formatINR(counters.totalShift)}</strong></span>
            <button
              onClick={toggleShift}
